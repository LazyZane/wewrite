...
export class MaterialView extends ItemView {
  ...
  async onOpen() {
    this.redraw();
    if (this.plugin.settings.selectedMPAccount !== undefined && this.plugin.assetsManager) {
  ...
  public readonly redraw = (): void => {
    ...
    const panels = this.plugin.assetsManager ? this.plugin.assetsManager.getMaterialPanels()
